...
$(SRCCACHE)/$(MBEDTLS_SRC)/mbedtls-ssl.h.patch-applied: $(SRCCACHE)/$(MBEDTLS_SRC)/source-extracted
	cd $(SRCCACHE)/$(MBEDTLS_SRC)/include/mbedtls && patch -p0 -f < $(SRCDIR)/patches/mbedtls-ssl.h.patch
	echo 1 > $@
$(BUILDDIR)/$(MBEDTLS_SRC)/build-configured: $(SRCCACHE)/$(MBEDTLS_SRC)/mbedtls-ssl.h.patch-applied
